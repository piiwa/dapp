...
const HomePage: NextPage = () => {
  ...
  async function fetchAPYData() {
    try {
      ...
      const providersAPYData = allPools.data.data.filter(
        (d: any) =>
          d.symbol === "USDC" &&
          d.chain === "Ethereum" &&
          d.poolMeta === null &&
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-3 text-center items-center">
            ...
            <p className="text-sm sm:text-xl font-medium">
              Discover the best yield for your stable coins and switch providers
              seamlessly with our intuitive application. Explore competitive APY
              rates and make your deposits with ease.{" "}
            </p>
